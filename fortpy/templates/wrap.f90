...
module fortpy
  ...
  public fpy_value_count, fpy_period_join_indices, fpy_linevalue_count_all, fpy_read_p
  public fpy_read_f, fpy_vararray, autoclass_analyze, fpy_set_verbosity, fpy_verbose
