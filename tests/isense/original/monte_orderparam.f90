...
module monte_orderparam
  ...
  type, public :: cluster_tracker
     ...
     !!<member name="correlations">
     !!  <summary>The vector of correlations calculated at the current temperature step.</summary>
     !!  <dimension index="1">The set of correlations calculated at a certain temperature.</dimension>
     !!  <dimension index="2">The relevant cluster in @CREF[this.clusters].</dimension>
     !!</member>
